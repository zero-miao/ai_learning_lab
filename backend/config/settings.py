...
if not SECRET_KEY:
    raise RuntimeError("DJANGO_SECRET_KEY must be configured in the root .env file.")
...
CORS_ALLOW_ALL_ORIGINS = True  # For local development as per PRD
...
DATABASES = {
    "default": {
        ...
        "NAME": PROJECT_ROOT / os.getenv("DJANGO_DATABASE_PATH", "backend/db.sqlite3"),
    }
}
